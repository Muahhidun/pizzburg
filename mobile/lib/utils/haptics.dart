...
abstract final class Haptics {
  ...
  /// Финальный замок заставки. Единственное место с тяжёлым импульсом:
  /// он закрывает рисунок из щелчков и читается как «встало на место».
  /// В остальном интерфейсе тяжёлый импульс не используется — иначе он
